package com.x.mlvision.di.appComponent

import android.app.Application
import com.x.mlvision.application.AppController
import com.x.mlvision.di.ActivityModule
import com.x.mlvision.di.ExoPlayerModule
 ...
 * */
@Component(modules = [ExoPlayerModule::class, ActivityModule::class, AndroidSupportInjectionModule::class])
@Singleton
